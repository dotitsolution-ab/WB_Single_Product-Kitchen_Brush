...
final class Security
{
    ...
    public static function ensureTables(): void
    {
        ...
        db()->exec('CREATE INDEX IF NOT EXISTS idx_login_attempts_lookup ON login_attempts (email, ip_address, attempted_at)');
        db()->exec('CREATE INDEX IF NOT EXISTS idx_login_attempts_attempted ON login_attempts (attempted_at)');
